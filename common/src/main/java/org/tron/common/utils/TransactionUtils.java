...
public class TransactionUtils {
  ...
  public static byte[] getHash(Protocol.Transaction transaction) {
    Protocol.Transaction.Builder tmp = transaction.toBuilder();
    //tmp.clearId();
  ...
  public static boolean validTransaction(Protocol.Transaction signedTransaction) {
    ...
    List<Protocol.Transaction.Contract> listContract = signedTransaction.getRawData().getContractList();
  ...
  public static Transaction setTimestamp(Protocol.Transaction transaction) {
