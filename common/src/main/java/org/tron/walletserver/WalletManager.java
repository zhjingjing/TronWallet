...
public class WalletManager {
    ...
    public static void initGRPC(Context context) {
        if (rpcCli != null) {
            rpcCli.shutdown();
        }
...
//        Context context = TronWalletApplication.getAppContext();
    ...
    public static void store(Context context,Wallet wallet, String password) throws DuplicateNameException, InvalidPasswordException, InvalidNameException {
        ...
        Set<String> walletNames = new HashSet<>(sharedPreferences.getStringSet(context.getString(R.string.wallets_key), new HashSet<String>()));
        ...
        if(!wallet.isWatchOnly()) {
            ...
            // SAVE PRIKEY
            walletEditor.putString(context.getString(R.string.private_key), privKeyStr);
        }

        Bundle bundle = new Bundle();
        bundle.putString("address", wallet.getAddress());
        bundle.putBoolean("is_watch", wallet.isWatchOnly());
//        FirebaseAnalytics.getInstance(context).logEvent("new_wallet", bundle);

        walletEditor.commit();
    }

    public static void storeWatchOnly(Context context,Wallet wallet) throws InvalidNameException, DuplicateNameException {
        wallet.setWatchOnly(true);
        try {
            store(context,wallet, null);
        } catch (InvalidPasswordException e) {
            e.printStackTrace();
        }
    }

    public static boolean existWallet(Context context,String walletName) {
        SharedPreferences sharedPreferences = context.getSharedPreferences(context.getString(R.string.preference_file_key), Context.MODE_PRIVATE);
    ...
    public static boolean existAnyWallet(Context context) {
        return !getWalletNames(context).isEmpty();
    }

    public static Set<String> getWalletNames(Context context) {
        SharedPreferences sharedPreferences = context.getSharedPreferences(context.getString(R.string.preference_file_key), Context.MODE_PRIVATE);
        return new HashSet<>(sharedPreferences.getStringSet(context.getString(R.string.wallets_key), new HashSet<String>()));
    }
    ...
    public static Wallet getSelectedWallet(Context context) {
        ...
        return getWallet(context,pref.getString(context.getString(R.string.selected_wallet_key), ""));
    }

    public static Wallet getWallet(Context context,String walletName, String password) {
        if (existWallet(context,walletName)) {
            ...
            String privateKeyEncrypted = walletPref.getString(context.getString(R.string.private_key), "");
            if (!privateKeyEncrypted.isEmpty()) {
                byte[] priKeyAscEnced = privateKeyEncrypted.getBytes();
                priKeyHexEnced = Hex.decode(priKeyAscEnced);

                if(password != null && checkPassword(context,walletName, password)) {
    ...
    public static Wallet getWallet(Context context,String walletName) {
        return getWallet(context,walletName, null);
    }

    public static void selectWallet(Context context,String walletName) {
        SharedPreferences sharedPreferences = context.getSharedPreferences(context.getString(R.string.preference_file_key), Context.MODE_PRIVATE);
    ...
    public static Transaction createTransferAssetTransaction(byte[] to, byte[] assertName,
        ...
        Contract.TransferAssetContract contract = createTransferAssetContract(to, assertName, owner,
                amount);
        return rpcCli.createTransferAssetTransaction(contract).getTransaction();
    }
    ...
    public static Transaction createParticipateAssetIssueTransaction(byte[] to, byte[] assertName,
        ...
        Contract.ParticipateAssetIssueContract contract = createParticipateAssetIssueContract(to, assertName,
                owner, amount);
        return rpcCli.createParticipateAssetIssueTransaction(contract).getTransaction();
    }
    ...
    public static Transaction createUpdateAccountTransaction(byte[] addressBytes, String accountName) {
        Contract.AccountUpdateContract contract = createAccountUpdateContract(ByteArray.fromString(accountName),
                addressBytes);
        return rpcCli.createTransaction(contract).getTransaction();
    }
    ...
    public static Transaction createWitnessTransaction(byte[] owner, byte[] url) {
        ...
        return rpcCli.createWitness(contract).getTransaction();
    }
    ...
    public static Transaction createUpdateWitnessTransaction(byte[] owner, byte[] url) {
        ...
        return rpcCli.updateWitness(contract).getTransaction();
    }
    ...
    public static Transaction createVoteWitnessTransaction(byte[] owner,
        ...
        return rpcCli.voteWitnessAccount(contract).getTransaction();
    }
    ...
    public static Transaction createAssetIssueTransaction(Contract.AssetIssueContract contract) {
        return rpcCli.createAssetIssue(contract).getTransaction();
    }

    public static GrpcAPI.BlockExtention getBlock(long blockNum, boolean useSolidity) {
    ...
    private static String loadPassword(Context context,String walletName) {
        if (context == null || !existWallet(context,walletName))
            return null;
    ...
    public static String loadPubKey(Context context,String walletName) {
        if (context == null || !existWallet(context,walletName))
            return null;
        SharedPreferences sharedPreferences = context.getSharedPreferences(walletName, Context.MODE_PRIVATE);
    ...
    private static String loadPriKey(Context context,String walletName) {
        if (context == null || !existWallet(context,walletName))
            return null;
        SharedPreferences sharedPreferences = context.getSharedPreferences(walletName, Context.MODE_PRIVATE);
        return sharedPreferences.getString(context.getString(R.string.private_key), null);
    }
    ...
    public static boolean checkPassword(Context context,String walletName, String password) {
        byte[] pwd = getPasswordHash(password);
        if (pwd == null) {
            return false;
        }
        String pwdAsc = ByteArray.toHexString(pwd);
        String pwdInstore = loadPassword(context,walletName);
    ...
    public static GrpcAPI.TransactionListExtention getTransactionsFromThis2(byte[] address, int offset, int limit) {
        return rpcCli.getTransactionsFromThis(address, offset, limit);
    }

    public static GrpcAPI.TransactionListExtention getTransactionsToThis2(byte[] address, int offset, int limit) {
    ...
    public static FreezeBalanceContract createFreezeBalanceContract(byte[] owner, long frozen_balance,
                                                                    long frozen_duration, Contract.ResourceCode resource) {
    ...
    public static Transaction createFreezeBalanceTransaction(byte[] owner, long frozen_balance, long frozen_duration, Contract.ResourceCode resource) {
        FreezeBalanceContract contract = createFreezeBalanceContract(owner, frozen_balance, frozen_duration, resource);
        return rpcCli.createTransaction(contract).getTransaction();
    }

    public static Transaction createUnfreezeBalanceTransaction(byte[] owner, Contract.ResourceCode resourceCode) {
        UnfreezeBalanceContract contract = createUnfreezeBalanceContract(owner, resourceCode);
        return rpcCli.createTransaction(contract).getTransaction();
    }

    public static UnfreezeBalanceContract createUnfreezeBalanceContract(byte[] owner, Contract.ResourceCode resourceCode) {
    ...
    public static GrpcAPI.BlockListExtention getBlockByLatestNum(long num) {
